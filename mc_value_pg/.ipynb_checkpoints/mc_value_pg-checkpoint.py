...
from eval_policy import eval_policy, eval_mc_value_pg
GAMMA_RATE = 0.6
...
def policy_iteration(args):
    ...
    for i in outer:
        ...
        eval_mc_value_pg(agent, 300, args.NUM_OF_PROCESSES)
        
#         print("start test the mc value policy")
#         thread_thunk((agent, 300, 2))
