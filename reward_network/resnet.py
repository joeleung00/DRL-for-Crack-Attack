...
class ResidualNet(nn.Module):
    def __init__(self, in_channels, n_classes, flatten_board_size, blocks_size, *args, **kwargs):
        super().__init__()
        self.encoder = Encoder(in_channels, 1, blocks_size, *args, **kwargs)
        self.decoder = Decoder(flatten_board_size, n_classes, blocks_sizes=[256])
